...
def tail_points(opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    assert type(opponent_score) == int, "Opponent score needs integer"
    assert opponent_score >= 0, "Opponent score needs non-negative"
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    score0, score1 = 0, 0
    number_dice = strategy(score0, score1)
    while score0 < goal:
      while score1 < goal:
        if number_dice != strategy(score0, score1):
          return False
        score1 = score1 + 1
      score1 = 0
      score0 = score0 + 1
...
def make_averaged(original_function, total_samples=1000):
    ...
    def averaged_dice(*args):
      ...
      averaged_score = total_score / total_samples
